...
router.get("/:id/profile",(b,d)=>{User.findOne({_id:b.params.id}).then(a=>{d.render("accounts/admin/profile",{profile:a})}).catch(a=>console.log(a))});router.get("/create",(b,d)=>{d.render("accounts/admin/users/create")});router.get("/dummy",(b,d)=>{d.render("accounts/admin/users/dummy")});router.get("/:id/edit",(b,d)=>{User.findOne({_id:b.params.id}).then(a=>{d.render("accounts/admin/users/edit",{user:a})}).catch(a=>console.log(a))});
