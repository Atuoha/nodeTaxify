...
icon:"error",timer:5500,closeOnClickOutside:!1}):swal({title:"Booking Success",text:"Kudos! You've successfully booked a taxi with nodeTaxify. Enjoy the ride! ",icon:"success",timer:5500,closeOnClickOutside:!1})}});$("#register_form").submit()});$("#timepicker1").timepicker();$("#datepicker2").datepicker();